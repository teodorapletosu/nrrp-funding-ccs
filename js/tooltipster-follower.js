  ...
  $.tooltipster._plugin({
    ...
    instance: {
      ...
      __init: function (instance) {
        ...
        self.__namespace =
          "tooltipster-follower-" + Math.round(Math.random() * 1000000);
        ...
        self.__instance._on("start." + self.__namespace, function (event) {
          self.__instance._$origin.on(
            "mousemove." + self.__namespace,
            function (e) {
        ...
        self.__instance._one(
          "startend." + self.__namespace + " startcancel." + self.__namespace,
          function (event) {
      ...
      __close: function () {
        ...
        if (
          typeof this.__instance.content() == "object" &&
          this.__instance.content() !== null
        ) {
      ...
      __create: function () {
        ...
        if (triggerClose.tap) {
          ...
          $document.on(
            "touchend." + self.__namespace + " touchcancel." + self.__namespace,
            function (event) {
      ...
      __follow: function (event) {
        ...
        if (event) {
          ...
          this.__helper.geo.window.scroll = {
            left:
              $.tooltipster._env.window.scrollX ||
              $.tooltipster._env.window.document.documentElement.scrollLeft,
            top:
              $.tooltipster._env.window.scrollY ||
              $.tooltipster._env.window.document.documentElement.scrollTop
          };
          ...
          if (anchor == "left-center" || anchor == "right-center") {
            ...
            if (anchor == "right-center") {
              ...
              if (coord.left < this.__helper.geo.window.scroll.left) {
                ...
                if (
                  event.pageX - offset[0] + this.__size.width <=
                  this.__helper.geo.window.scroll.left +
                    this.__helper.geo.window.size.width
                ) {
                  // move to the right
                  anchor = "left-center";
            ...
            if (
              coord.top + this.__size.height >
              this.__helper.geo.window.scroll.top +
            ...
            if (
              coord.top + this.__size.height >
              this.__helper.geo.document.size.height
            ) {
              // move up
              coord.top =
                this.__helper.geo.document.size.height - this.__size.height;
            }
          ...
          if (anchor != "left-center" && anchor != "right-center") {
            ...
            var pointerViewportY =
              event.pageY - this.__helper.geo.window.scroll.top;
            ...
            if (anchor.indexOf("bottom") == 0) {
              ...
              if (coord.top < this.__helper.geo.window.scroll.top) {
                ...
                if (
                  ...
                  (pointerViewportY <
                    this.__helper.geo.window.size.height - pointerViewportY &&
                    event.pageY + offset[1] + this.__size.height <=
                      this.__helper.geo.document.size.height)
                ) {
                  coord.top = event.pageY + offset[1];
                }
            ...
            // similar logic
              ...
              if (
                ...
                if (
                  pointerViewportY >
                    this.__helper.geo.window.size.height - pointerViewportY ||
                  pointerViewportY - offset[1] + this.__size.height <=
                    this.__helper.geo.document.size.height
                ) {
          ...
          this.__instance._$tooltip.hide();
        }
